						...
						<div className="row footer-info w3-agileits-info">
							...
							<div className="col-md-3 col-sm-6 footer-grids mt-md-0 mt-4">
								...
								<ul>
									...
									<li className="mb-3">
										<i className="fas fa-mobile"></i> 09340334221 </li>
									
									<li className="mb-3">
										<i className="fas fa-envelope-open"></i>
										<a href="mailto:support@mega-shop.co.in"> support@mega-shop.co.in</a>
									</li>
				...
				{/* <div className="agile-sometext py-md-5 py-sm-4 py-3">
					<div className="container">
						...
						<div className="sub-some child-momu mt-4">
							...
							<ul>
								<li>
									<img src="./web/images/pay2.png" alt="" />
								</li>
								<li>
									<img src="./web/images/pay5.png" alt="" />
								</li>
								<li>
									<img src="./web/images/pay1.png" alt="" />
								</li>
								<li>
									<img src="./web/images/pay4.png" alt="" />
								</li>
								<li>
									<img src="./web/images/pay6.png" alt="" />
								</li>
								<li>
									<img src="./web/images/pay3.png" alt="" />
								</li>
								<li>
									<img src="./web/images/pay7.png" alt="" />
								</li>
								<li>
									<img src="./web/images/pay8.png" alt="" />
								</li>
								<li>
									<img src="./web/images/pay9.png" alt="" />
								</li>
							</ul>
						</div>
					</div>
